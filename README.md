...
I have included a UNIX executable under 'releases'.  The executible can be downloaded and ran from the terminal by typing ./File_Audit_System_cpp and pressing enter.
